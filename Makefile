...
BUILTINS_SRCS = $(addprefix $(BUILTINS_DIR)/, builtins_cd_pwd.c builtins_echo.c builtins_exit.c builtins_env.c builtins_env_export_utils.c builtins_export.c builtins_unset_utils.c builtins_unset.c builtins_env_print.c builtins_export_utils.c builtins_env_convert_utils.c)
